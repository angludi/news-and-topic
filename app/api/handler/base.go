...
func RespondJSONWithStatusCode(c *gin.Context, statusCode int, data interface{}) {
	c.JSON(statusCode, data)
	return
}
...
func RespondAttachment(c *gin.Context, contentType, filename string, b *bytes.Buffer) {
